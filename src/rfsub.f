...
c
c     Modifications implemented in the package iRF:
c     Changed uniform random sampling of features at node splits to a 
c     weighted sampling scheme, implemented in the new subroutine
c     selectsplit at the end of this file. 
c
...
c     compute initial values of numerator and denominator of Gini
      pno = 0.0
      pdo = 0.0
c     gini purity = (no. of data points in a node)* (\sum_{j=1}^k p_j^2)	  
      do j = 1, nclass
